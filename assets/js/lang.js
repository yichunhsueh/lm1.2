...
const LANG = {
  zh: {
    ...
    originP2: 'LIFE+透過創造來修復靈魂。是核心天賦與本能，似黑暗中的一束微光。<br>於是我決定善用這份「美的轉譯」能力，開啟一項從「助人」而衍生的設計計畫——<br>旨在協助安定情緒、療癒心理，在科學上也具有活化大腦、減緩未來失智風險的依據。',
    originP3: '願 LIFE+能幫助大家在面對生命突如其來的變故與黑夜時，心中多一份底氣與力量。<br>我們不需要在慌亂中四處抓取，願迷失的人們都能看見光亮，找到出口。',
    originP4: '讓 LIFE+ 陪您一起，將稍縱即逝的瞬間，轉化為宇宙中溫暖而永恆的幾何年輪。',
    faqItems: [
    ...
    footerCol1Lines: ['工作室名稱：XUEXUEni 數位生命美學工作室','商業聯名 / 實體雷雕媒合：'],
    footerCol2Title: '架構導覽',
    footerCol2Links: [['#experience','體驗生命解碼'],['#philosophy','大師核心架構'],['#solutions','留存場景方案']],
    footerCopy: '© 2026 LIFE System & XUEXUEni Studio. All Rights Reserved.',
  ...
  en: {
    ...
    originP2: 'LIFE+ heals the soul through creation — it is a core gift and instinct, a faint light in the darkness.<br>So I decided to use this ability to "translate beauty" and launched a design initiative born from the desire to help others — aimed at stabilizing emotions, healing the mind, with scientific backing for activating the brain and reducing future dementia risk.',
    originP3: 'May LIFE+ help everyone find more courage and strength when facing sudden upheaval and dark nights in life.<br>We don\'t need to grasp frantically in the chaos. May those who are lost see the light and find the way out.',
    originP4: 'Let LIFE+ accompany you in transforming fleeting moments into warm and eternal geometric rings in the universe.',
    faqItems: [
    ...
    footerCol1Lines: ['Studio: XUEXUEni Digital Life Aesthetics Studio','Collaboration / Laser Engraving Inquiries: '],
